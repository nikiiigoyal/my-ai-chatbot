...
export default function ChatDemo() {
  ...
  return (
    <div className="flex flex-col justify-center h-full px-8 lg:px-16 bg-gray-850 border-l-2 border-gray-800">
      <div className="rounded-2xl p-6 mx-auto w-full h-full flex flex-col">
        {/* Chat Header */}
        ...
        <form onSubmit={handleSubmit} className="relative">
          ...
          <button
            ...
            className="absolute bottom-4 right-4 bg-gray-700 hover:bg-gray-600 p-2 rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <div className="flex space-x-1">
